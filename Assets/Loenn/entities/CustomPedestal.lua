...
customPedestal.fieldInformation = {
    ...
    entityTypes           = { fieldType = "string", description = "Semicolon-separated entity type names and/or numeric Lönn entity IDs to track. Entities must be holdable." },
    ...
    triggerMoverOn		  = { fieldType = "string", description = "Comma-separated list of what actions to activate static movers on.\nAccepted values: grab, dash, explode, repair, claim" },
